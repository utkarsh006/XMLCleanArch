    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent?.let {
            ...
            if (coinId.isNotBlank()) {
                ...
                Toast.makeText(
                    this@CoinActivity,
                    "We don't have any id to call", Toast.LENGTH_LONG
                ).show()
            }
        }
    }
                ...
                withContext(Dispatchers.Main) {
                    if (value.isLoading) {
                        ...
                        value.coinDetail?.let { coinDetail ->
                            ...
                            binding.txtCoinPriceLow.text =
                                "Coin Price : ${coinDetail.lowPrice.toString()}"
                            binding.txtCoinPriceHigh.text =
                                "Coin Price High : ${coinDetail.highPrice.toString()}"
                            binding.txtCoinMarketCap.text =
                                "Coin Market Cap : ${coinDetail.market_cap.toString()}"
